...
<body>
    <div class="container">
        ...
        <p>Solicitamos que preencha o formulário com as informações necessárias e faça o upload dos documentos exigidos. Este passo é essencial para prosseguirmos com o processo de forma eficiente.</p>
        <p>Estamos à disposição para quaisquer dúvidas ou assistência adicional. Agradecemos antecipadamente pela sua colaboração e aguardamos o envio dos documentos.</p>
        <p>Atenciosamente,</p>
    </div>
</body>
</html>
